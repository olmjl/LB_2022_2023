...
public class MainAct07_v2_Linux {

    public static void main(String[] args) throws IOException {

        //Creamos objetos File
        File rutaDirectorioPadre = new File(System.getProperty("user.home") + "/Documentos/ad/ut1_act07");
...
//        rutaFicheroDat.setExecutable(false);
        rutaFicheroDat.setWritable(true);
